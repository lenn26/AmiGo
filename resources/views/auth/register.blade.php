                        ...
                        <div x-data="{ show: false }">
                            ...
                            <div class="relative">
                                ...
                                <input id="password" :type="show ? 'text' : 'password'" name="password" required autocomplete="new-password"
                                    placeholder="**********"
                                    class="w-full px-4 py-3 bg-gray-50 border border-gray-100 rounded-lg focus:ring-2 focus:ring-[#56BA8D] focus:border-[#56BA8D] outline-none transition text-gray-900 placeholder-gray-400 pr-10">
                        ...
                        <div x-data="{ show: false }">
                            ...
                            <div class="relative">
                                ...
                                <input id="password_confirmation" :type="show ? 'text' : 'password'" name="password_confirmation" required autocomplete="new-password"
                                    placeholder="**********"
                                    class="w-full px-4 py-3 bg-gray-50 border border-gray-100 rounded-lg focus:ring-2 focus:ring-[#56BA8D] focus:border-[#56BA8D] outline-none transition text-gray-900 placeholder-gray-400 pr-10">
                                <!-- Bouton afficher/masquer le mot de passe de confirmation -->
                                <button type="button" @click="show = !show" class="absolute inset-y-0 right-0 pr-3 flex items-center text-gray-400 hover:text-gray-600">
                                    <svg x-show="!show" class="h-5 w-5" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                                        <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M15 12a3 3 0 11-6 0 3 3 0 016 0z" />
                                        <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M2.458 12C3.732 7.943 7.523 5 12 5c4.478 0 8.268 2.943 9.542 7-1.274 4.057-5.064 7-9.542 7-4.477 0-8.268-2.943-9.542-7z" />
